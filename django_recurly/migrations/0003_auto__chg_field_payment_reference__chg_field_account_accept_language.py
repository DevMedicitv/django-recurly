...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.reference'
        db.alter_column('django_recurly_payment', 'reference', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Account.accept_language'
        db.alter_column('django_recurly_account', 'accept_language', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))

    def backwards(self, orm):

        # Changing field 'Payment.reference'
        db.alter_column('django_recurly_payment', 'reference', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Account.accept_language'
        db.alter_column('django_recurly_account', 'accept_language', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
    ...
    models = {
        ...
        'django_recurly.account': {
            ...
            'accept_language': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
