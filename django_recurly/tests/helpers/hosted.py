...
class GetSubscribeUrlTest(BaseTest):
    ...
    def test_encoding(self):
        expected = "https://{SUBDOMAIN}.recurly.com/subscribe/myplan/mya%C3%A7%C3%A7o+unt/ad%2Fa%C3%A5m?quantity=2&first_name=%C3%85dam&last_name=%C3%87harnock&email=adam@test.com".replace("{SUBDOMAIN}", django_recurly.conf.SUBDOMAIN)
